...
download('https://raw.githubusercontent.com/js-org/js.org/master/cnames_active.js', 'tmp_data.js', () => {
    ...
    fs.writeFileSync('output/cnames_active.json', JSON.stringify(data.cnames_active));
    fs.writeFileSync('output/subdomains_registered.json', JSON.stringify(Object.keys(data.cnames_active).map(value => `${value}.js.org`)));
})